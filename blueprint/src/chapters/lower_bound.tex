...
\lean{Essakine2026Tight.statesLaw_hardMDP, Essakine2026Tight.stateSeqLaw_hardMDP_path, Essakine2026Tight.stateSeqLaw_hardMDP_arrival, Essakine2026Tight.stateSeqLaw_hardMDP_absorbing, Essakine2026Tight.hardTransFun_absorbing, Essakine2026Tight.hardTransFun_path, Essakine2026Tight.hardTransFun_arrival, Essakine2026Tight.hardMDP_trans_apply, Learning.MDP.Episodic.stateSeqLaw, Learning.MDP.Episodic.stateSeqLaw_castSucc, Learning.MDP.Episodic.stateSeqLaw_last, Learning.MDP.Episodic.statesLaw_eq_map_stateSeqLaw, ProbabilityTheory.ae_bernoulliMeasure}\leanok
...
\texttt{statesLaw\_hardMDP}, \texttt{statesLaw (hardMDP H β ε u) (stateAt S 0) π = (bernoulliMeasure (stateAt S 1) (stateAt S 2) (succProb β ε H u π)).map (pathSeq π)}.
It is proved by backward induction on the steps with the law of the state sequence from a step
(\texttt{Learning.MDP.Episodic.stateSeqLaw}, whose one-step recursion \texttt{stateSeqLaw\_castSucc} comes
from Lemma~\ref{lem:step_law_markov}): absorbing states after the arrival
(\texttt{stateSeqLaw\_hardMDP\_absorbing}), the Bernoulli step at the arrival
...
\lean{Essakine2026Tight.hardZ, Essakine2026Tight.hardZ_pos, Essakine2026Tight.expValue_hardMDP_start, Essakine2026Tight.expValue_hardMDP_path, Essakine2026Tight.expValue_hardMDP_good, Essakine2026Tight.expValue_hardMDP_bad, Essakine2026Tight.vecExp_hardMDP_transVec, Essakine2026Tight.integrable_exp_hardMDP, Essakine2026Tight.rewardCount, Essakine2026Tight.hardReward_path}\leanok
...
\texttt{statesEnv M s₁ := stationaryEnv (statesKernel M s₁)} by
