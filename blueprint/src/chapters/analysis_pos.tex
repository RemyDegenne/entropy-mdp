...
\texttt{vecVar (M.transVec h s a) (expValue M H β π.extend (h + 1))} and the rate terms are
...
pointwise. In Lean the two statements are two lemmas for a run in \texttt{statesEnv M H s₁}, with $\delta \in (0, 1]$
